...
-- CREATE INDEX IF NOT EXISTS idx_document_analyses_org_id ON document_analysis(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_document_analyses_document_id ON document_analysis(document_id);
