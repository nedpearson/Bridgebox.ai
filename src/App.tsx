...
const SalesOnboarding = lazy(
  () => import("./pages/onboarding/SalesOnboarding"),
);
...
const ClientProjects = lazy(
  () => import("./pages/client-portal/ClientProjects"),
);
const ClientDeliverables = lazy(
  () => import("./pages/client-portal/ClientDeliverables"),
);
...
const ClientSettings = lazy(
  () => import("./pages/client-portal/ClientSettings"),
);
...
const SupportTicketDetail = lazy(
  () => import("./pages/app/SupportTicketDetail"),
);
const ClientSupportDetail = lazy(
  () => import("./pages/client-portal/ClientSupportDetail"),
);
const DeliveryOverview = lazy(() => import("./pages/app/DeliveryOverview"));
const ProjectDeliveryDetail = lazy(
  () => import("./pages/app/ProjectDeliveryDetail"),
);
const ConversionsDashboard = lazy(
  () => import("./pages/app/ConversionsDashboard"),
);
const ProposalView = lazy(() => import("./pages/ProposalView"));
const Analytics = lazy(() => import("./pages/app/Analytics"));
const ExecutiveCommandCenter = lazy(
  () => import("./pages/app/ExecutiveCommandCenter"),
);
const ImplementationCenter = lazy(
  () => import("./pages/app/ImplementationCenter"),
);
const ImplementationDetail = lazy(
  () => import("./pages/app/ImplementationDetail"),
);
const ClientSuccess = lazy(() => import("./pages/app/ClientSuccess"));
const ClientSuccessDetail = lazy(
  () => import("./pages/app/ClientSuccessDetail"),
);
...
const WorkflowBuilder = lazy(() =>
  import("./pages/app/WorkflowBuilder").then((module) => ({
    default: module.WorkflowBuilder,
  })),
);
const WorkflowTemplates = lazy(() =>
  import("./pages/app/WorkflowTemplates").then((module) => ({
    default: module.WorkflowTemplates,
  })),
);
const WorkflowExecutions = lazy(() =>
  import("./pages/app/WorkflowExecutions").then((module) => ({
    default: module.WorkflowExecutions,
  })),
);
const Documents = lazy(() =>
  import("./pages/app/Documents").then((module) => ({
    default: module.Documents,
  })),
);
const DocumentDetail = lazy(() =>
  import("./pages/app/DocumentDetail").then((module) => ({
    default: module.DocumentDetail,
  })),
);
...
const CommunicationDetail = lazy(
  () => import("./pages/app/CommunicationDetail"),
);
...
const MobileProjectDetail = lazy(
  () => import("./pages/mobile/MobileProjectDetail"),
);
...
const AiOnboardingWizard = lazy(
  () => import("./pages/onboarding/AiOnboardingWizard"),
);
const OnboardingCommandCenter = lazy(
  () => import("./pages/app/OnboardingCommandCenter"),
);
import OnboardingShell from "./components/onboarding/layout/OnboardingShell";
const ClientIntakeWorkspace = lazy(
  () => import("./pages/onboarding/ClientIntakeWorkspace"),
);
const CompetitorAnalysisWorkspace = lazy(
  () => import("./pages/onboarding/CompetitorAnalysisWorkspace"),
);
const WorkflowCaptureWorkspace = lazy(
  () => import("./pages/onboarding/WorkflowCaptureWorkspace"),
);
const BlueprintReviewWorkspace = lazy(
  () => import("./pages/onboarding/BlueprintReviewWorkspace"),
);
const AdminCommandCenterLayout = lazy(
  () => import("./pages/onboarding/admin/AdminCommandCenterLayout"),
);
const AdminHubOverview = lazy(
  () => import("./pages/onboarding/admin/AdminHubOverview"),
);
const TaskPlanBoard = lazy(
  () => import("./pages/onboarding/admin/TaskPlanBoard"),
);
const PromptBuilderPanel = lazy(
  () => import("./pages/onboarding/admin/PromptBuilderPanel"),
);
const DashboardPreferenceBuilder = lazy(
  () => import("./pages/onboarding/admin/DashboardPreferenceBuilder"),
);
const IntegrationMapBuilder = lazy(
  () => import("./pages/onboarding/admin/IntegrationMapBuilder"),
);
const IntegrationIngestionLog = lazy(
  () => import("./pages/onboarding/admin/IntegrationIngestionLog"),
);
const FeatureIngestionCard = lazy(
  () => import("./pages/onboarding/admin/FeatureIngestionCard"),
);
const CommandCenterDashboard = lazy(
  () => import("./pages/internal/CommandCenterDashboard"),
);
...
const AdminSupportTicketDetail = lazy(
  () => import("./pages/internal/modules/SupportTicketDetail"),
);
const SupportAnalytics = lazy(
  () => import("./pages/internal/modules/SupportAnalytics"),
);
const DevTasksWorkspace = lazy(
  () => import("./pages/internal/modules/DevTasksWorkspace"),
);
const DevTaskDetail = lazy(
  () => import("./pages/internal/modules/DevTaskDetail"),
);
const BugReportsWorkspace = lazy(
  () => import("./pages/internal/modules/BugReportsWorkspace"),
);
const BugReportDetail = lazy(
  () => import("./pages/internal/modules/BugReportDetail"),
);
const QaTestCasesWorkspace = lazy(
  () => import("./pages/internal/modules/QaTestCasesWorkspace"),
);
const QaTestCaseDetail = lazy(
  () => import("./pages/internal/modules/QaTestCaseDetail"),
);
...
const AiPipelineMonitor = lazy(
  () => import("./pages/internal/modules/AiPipelineMonitor"),
);
const ErrorConsole = lazy(
  () => import("./pages/internal/modules/ErrorConsole"),
);
const IntegrationHealth = lazy(
  () => import("./pages/internal/modules/IntegrationHealth"),
);
const ConfigInspector = lazy(
  () => import("./pages/internal/modules/ConfigInspector"),
);
const InternalNotes = lazy(
  () => import("./pages/internal/modules/InternalNotes"),
);
const SystemDiagnostics = lazy(
  () => import("./pages/internal/modules/SystemDiagnostics"),
);
const AuditTrail = lazy(() => import("./pages/internal/modules/AuditTrail"));
const AiKnowledgeBase = lazy(
  () => import("./pages/internal/modules/AiKnowledgeBase"),
);
const AiValidationSuite = lazy(
  () => import("./pages/internal/modules/AiValidationSuite"),
);
import LoadingSpinner from "./components/LoadingSpinner";
const StackDiscoveryWizard = lazy(
  () => import("./pages/app/StackDiscoveryWizard"),
);
const AgentControlRoom = lazy(
  () => import("./pages/internal/modules/AgentControlRoom"),
);
const TemplateStudio = lazy(
  () => import("./pages/internal/modules/TemplateStudio"),
);
const PricingCommandCenter = lazy(
  () => import("./pages/admin/PricingCommandCenter"),
);
const PricingPresentation = lazy(
  () => import("./pages/onboarding/PricingPresentation"),
);
...
const SoftwareDiscoveryOnboarding = lazy(
  () => import("./pages/onboarding/SoftwareDiscoveryOnboarding"),
);

// Super Admin Layouts & Components
import SuperAdminLayout from "./layouts/SuperAdminLayout";
const SuperAdminOverview = lazy(
  () => import("./pages/admin/SuperAdminOverview"),
);
        ...
        <CopilotProvider>
          ...
          >
            <Routes>
              ...
              />
              <Route
                path="/app/software-discovery"
                element={
                  <ProtectedRoute>
                    <SoftwareDiscoveryOnboarding />
                  </ProtectedRoute>
                }
              />
              <Route
              ...
              >
                ...
                <Route
                  path="analysis"
                  element={<CompetitorAnalysisWorkspace />}
                />
                <Route
                  path="voice-capture"
                  element={<WorkflowCaptureWorkspace />}
                />
                ...
                <Route path="admin/*" element={<AdminCommandCenterLayout />}>
                  ...
                  <Route
                    path="webhooks"
                    element={<IntegrationIngestionLog />}
                  />
                  <Route
                    path="dashboards"
                  ...
                  <Route
                    ...
                    element={
                      <div className="p-4 bg-slate-900 rounded-xl border border-slate-800 text-white">
                        Progress Tracker Roadmap (Phase 13)
                      </div>
                    }
                  />
                </Route>
                      ...
                      <AppLayout>
                        ...
                        >
                          <Routes>
                            ...
                            <Route
                              path="/implementation"
                              element={<ImplementationCenter />}
                            />
                            <Route
                              path="/implementation/:projectId"
                            ...
                            />
                            <Route
                              path="/client-success/:clientId"
                              element={<ClientSuccessDetail />}
                            />
                            <Route
                              path="/automations"
                              element={<Automations />}
                            ...
                            <Route
                              path="/tasks"
                              element={<GlobalTasksList />}
                            />
                            <Route
                              path="/tasks/:id"
                              element={<GlobalTaskDetail />}
                            />
                            <Route
                              path="/communications"
                            ...
                            />
                            <Route
                              path="/templates/ai-wizard"
                              element={<AiTemplateWizard />}
                            />
                            <Route
                              path="/templates/:id"
                            ...
                            <Route
                              ...
                              element={<MobileAppStudio />}
                            />
                            <Route
                              path="/settings/audit"
                              element={<AuditLogSettings />}
                            />
                            <Route
                            ...
                            />
                            <Route
                              path="/stack-discovery"
                              element={<StackDiscoveryWizard />}
                            />
                            <Route
                              path="/onboarding-command"
                              element={<OnboardingCommandCenter />}
                            />
                      ...
                      <RecordingCenterLayout>
                        ...
                        >
                          <Routes>
                            ...
                            />
                            <Route
                              path="/recording-center/capture"
                              element={<RecorderUI />}
                            />
                            <Route
                              path="/recording-center/library"
                              element={<RecordingLibrary />}
                            />
                            <Route
                              path="/recording-center/support"
                              element={<SupportDesk />}
                            />
                            <Route
                              path="/recording-center/support/:id"
                              element={<AdminSupportTicketDetail />}
                            />
                            <Route
                              path="/recording-center/support-analytics"
                              element={<SupportAnalytics />}
                            />
                            <Route
                              path="/recording-center/dev-tasks"
                              element={<DevTasksWorkspace />}
                            />
                            <Route
                              path="/recording-center/dev-tasks/:id"
                              element={<DevTaskDetail />}
                            />
                            <Route
                              path="/recording-center/bug-reports"
                              element={<BugReportsWorkspace />}
                            />
                            <Route
                              path="/recording-center/bug-reports/:id"
                              element={<BugReportDetail />}
                            />
                            <Route
                              path="/recording-center/qa-test-cases"
                              element={<QaTestCasesWorkspace />}
                            />
                            <Route
                              path="/recording-center/qa-test-cases/:id"
                              element={<QaTestCaseDetail />}
                            />
                            <Route
                              path="/recording-center/web"
                              element={<WebAccess />}
                            />
                            <Route
                              path="/recording-center/logs"
                              element={<LogsViewer />}
                            />
                            <Route
                              path="/recording-center/jobs"
                              element={<JobsMonitor />}
                            />
                            <Route
                              path="/recording-center/ai-pipeline"
                              element={<AiPipelineMonitor />}
                            />
                            <Route
                              path="/recording-center/ai-knowledge"
                              element={<AiKnowledgeBase />}
                            />
                            <Route
                              path="/recording-center/ai-validation"
                              element={<AiValidationSuite />}
                            />
                            <Route
                              path="/recording-center/errors"
                              element={<ErrorConsole />}
                            />
                            <Route
                              path="/recording-center/integrations"
                              element={<IntegrationHealth />}
                            />
                            <Route
                              path="/recording-center/notes"
                              element={<InternalNotes />}
                            />
                            <Route
                              path="/recording-center/config"
                              element={<ConfigInspector />}
                            />
                            <Route
                              path="/recording-center/diagnostics"
                              element={<SystemDiagnostics />}
                            />
                            <Route
                              path="/recording-center/audit"
                              element={<AuditTrail />}
                            />
                            <Route
                              path="/recording-center/agents"
                              element={<AgentControlRoom />}
                            />
                            <Route
                              path="/recording-center/pricing"
                              element={<PricingCommandCenter />}
                            />
                            <Route
                              path="/recording-center/pricing-simulator"
              ...
              {isCustomDomain && <Route path="*" element={<Login />} />}
