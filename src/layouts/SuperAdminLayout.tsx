    ...
    <div className="min-h-screen bg-slate-950 flex font-sans selection:bg-[#3B82F6]/30">
      ...
      >
        ...
        <div className="p-4 flex-1 overflow-y-auto space-y-6 scrollbar-hide">
           <div>
              <div className="text-xs font-black text-slate-500 uppercase tracking-widest pl-3 mb-3">Core Infrastructure</div>
        ...
        <div className="p-4 border-t border-white/10">
           <Button variant="ghost" onClick={() => navigate('/app')} className="w-full justify-center text-slate-400 hover:text-white group">
             <ArrowLeft className="w-4 h-4 mr-2 group-hover:-translate-x-1 transition-transform" /> Exit to Client OS
           </Button>
        </div>
      </motion.aside>
