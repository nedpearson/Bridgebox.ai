...
export default function RecordingCenterLayout({
  children,
}: {
  ...
  const navLinks = [
    ...
    },
    {
      ...
      path: "/app/internal/recording-center/capture",
      icon: Video,
    },
    {
      name: "Recording Library",
      path: "/app/internal/recording-center/library",
      icon: Terminal,
    },
    {
      name: "Support Inquiries",
      path: "/app/internal/recording-center/support",
      icon: Activity,
    },
    {
      name: "Dev Tasks Inbox",
      path: "/app/internal/recording-center/dev-tasks",
      icon: Code2,
    },
    {
      name: "Bug Reports",
      path: "/app/internal/recording-center/bug-reports",
      icon: Bug,
    },
    {
      name: "QA Test Cases",
      path: "/app/internal/recording-center/qa-test-cases",
      icon: TestTube2,
    },
    {
      name: "Support Analytics",
      path: "/app/internal/recording-center/support-analytics",
      icon: PieChart,
    },
    {
      name: "Web Access",
      path: "/app/internal/recording-center/web",
      icon: Globe,
    },
    {
      name: "AI Capability Editor",
      path: "/app/internal/recording-center/ai-knowledge",
      icon: Brain,
    },
    {
      name: "AI Validation Suite",
      path: "/app/internal/recording-center/ai-validation",
      icon: Database,
    },
    {
      name: "Template Studio",
      path: "/app/internal/recording-center/templates",
      icon: LayoutTemplate,
    },
    {
      name: "Pricing Command Center",
      path: "/app/internal/recording-center/pricing",
      icon: DollarSign,
    },
  ];
