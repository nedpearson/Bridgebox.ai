...
export const CATEGORY_COLORS: Record<DocumentCategory, { bg: string; text: string; border: string }> = {
  onboarding_guides: { bg: 'bg-blue-500/10', text: 'text-blue-400', border: 'border-blue-500/20' },
  system_documentation: { bg: 'bg-purple-500/10', text: 'text-purple-400', border: 'border-purple-500/20' },
  integration_guides: { bg: 'bg-green-500/10', text: 'text-green-400', border: 'border-green-500/20' },
  client_instructions: { bg: 'bg-amber-500/10', text: 'text-amber-400', border: 'border-amber-500/20' },
  internal_sops: { bg: 'bg-red-500/10', text: 'text-red-400', border: 'border-red-500/20' },
};
...
export const VISIBILITY_COLORS: Record<DocumentVisibility, { bg: string; text: string; border: string }> = {
  internal: { bg: 'bg-slate-500/10', text: 'text-slate-400', border: 'border-slate-500/20' },
  client: { bg: 'bg-blue-500/10', text: 'text-blue-400', border: 'border-blue-500/20' },
  public: { bg: 'bg-green-500/10', text: 'text-green-400', border: 'border-green-500/20' },
};
