...
export const schemaNormalizer = {
  ...
  async ingestForeignPayload(
    ...
    if (!organizationId)
      throw new Error("Organization ID is required to map a webhook payload.");
        ...
        messages: [
          {
            role: "system",
            content:
              "You are an autonomous schema translation engine mapping integration hooks. Output exclusively valid JSON object formats.",
          },
