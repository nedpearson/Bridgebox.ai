...
export const bridgeboxOntology: GraphNode[] = [
  ...
  // ADMIN RECORDING CENTER (Secret / Internal Only)
  {
    ...
    type: 'module',
    description: 'Highly restricted master observatory. Records internal interactions, audits API traces, triggers internal Bug & Dev QA generations via Copilot, maps underlying cluster health, and provides autonomous AI validation simulation logic natively to admins.',
    relatedNodes: ['page:admin_logs', 'page:ai_pipeline_monitor', 'page:bug_reports', 'page:dev_tasks', 'page:qa_test_cases', 'page:ai_validation_suite'],
