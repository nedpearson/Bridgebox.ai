import type { Plan, FeatureKey, AddOnDefinition, AddOnType, PlanTier } from '../types/billing';
...
export const PLANS: Plan[] = [
  {
    ...
    tier: 'starter',
    name: 'Starter',
    tagline: 'Get your software vision out of your head and into a working plan.',
    description: 'For businesses beginning to capture and design their custom platform.',
  ...
  },
  {
    ...
    tier: 'growth',
    name: 'Growth',
    tagline: 'Actively shape a custom platform built around your exact workflow.',
    description: 'For businesses customizing software around their specific operations.',
  ...
  },
  {
    ...
    tier: 'pro',
    name: 'Pro',
    tagline: 'Run multiple workflows, reusable modules, and deeper AI-driven software evolution.',
    description: 'For operators managing multiple clients or complex multi-workspace deployments.',
  ...
  },
  {
    ...
    tier: 'enterprise',
    name: 'Enterprise',
    tagline: 'Governance, scale, and a custom rollout across your organization.',
    description: 'For organizations needing custom limits, audit controls, SSO, and dedicated support.',
    pricing: {},
...
export const ADD_ONS: AddOnDefinition[] = [
  {
    id: 'credit_pack_100',
    name: '100 AI Credits',
    description: 'Top up your workspace with 100 additional AI credits. Credits expire 90 days after purchase.',
    price: 9900,            // $99
    creditValue: 100,
    category: 'credits',
  },
  {
    id: 'credit_pack_500',
    name: '500 AI Credits',
    description: 'Best value — 500 credits for large discovery sessions or multi-client work.',
    price: 39900,           // $399
    creditValue: 500,
    category: 'credits',
  },
  {
    ...
    description: 'Power user pack — 1,000 credits for enterprise-scale discovery and blueprint work.',
    price: 69900,           // $699
    creditValue: 1000,
    category: 'credits',
  },
  {
    ...
    description: 'Add 10 additional screen recording analyses to your current billing period.',
    price: 4900,            // $49
    recordingValue: 10,
    category: 'recordings',
  },
  {
    ...
    description: 'Guided 3-session onboarding with a Bridgebox specialist to capture your full software vision.',
    price: 149900,          // $1,499
    category: 'services',
  },
  {
    ...
    description: 'Full data migration from your existing systems into your new custom platform.',
    price: 299900,          // $2,999
    category: 'services',
  },
  {
    ...
    description: 'White-glove workspace configuration, intelligence profile setup, and team onboarding.',
    price: 99900,           // $999
    category: 'services',
  },
  {
    ...
    description: 'Dedicated 2-week implementation sprint for a specific feature or workflow.',
    price: 499900,          // $4,999
    category: 'services',
  },
  {
  ...
  },
  {
    ...
    description: 'Unlock predictive AI recommendations for a single workspace for 3 months.',
    price: 29900,           // $299
    category: 'services',
  },
];
...
export const getPlanTierOrder = (): PlanTier[] => ['starter', 'growth', 'pro', 'enterprise'];
