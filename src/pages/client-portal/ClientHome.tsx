  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      if (primaryOrg) {
        ...
        const projects = await projectsService.getProjectsByOrganization(
          primaryOrg.id,
        );
        setActiveProjects(
          projects
        ...
        setRecentTickets(
          tickets?.filter((t: any) => t.status !== "closed").slice(0, 3) || [],
        );
        setStats((prev) => ({
          ...prev,
          openTickets:
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid lg:grid-cols-4 gap-6 mb-8">
          ...
          <Link to="/portal/projects">
            <Card
              glass
              className="p-6 hover:border-[#10B981]/30 transition-all duration-300 cursor-pointer"
            >
              <div className="flex items-center justify-between mb-2">
          ...
          <Link to="/portal/support?status=open">
            <Card
              glass
              className="p-6 hover:border-yellow-500/30 transition-all duration-300 cursor-pointer"
            >
              <div className="flex items-center justify-between mb-2">
                  ...
                  <Link to={`/portal/support/${ticket.id}`} key={ticket.id}>
                    ...
                    >
                      <div className="flex items-start justify-between mb-2">
                        <h3 className="text-white font-medium flex-1 group-hover:text-indigo-500 transition-colors">
                          {ticket.title}
                        </h3>
                        <StatusBadge
