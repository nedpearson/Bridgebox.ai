      ...
      if (primaryOrg) {
        ...
        for (const project of projects || []) {
          const projectDeliverables =
            await projectsService.getProjectDeliverables(project.id);
            ...
            if (d.file_references && d.file_references.length > 0) {
              try {
                ...
                return {
                  ...
                  url,
                  file_name:
                    typeof d.file_references[0] === "string"
                      ? d.file_references[0]
                      : d.file_references[0].name,
                };
              } catch (err) {
                return d;
              }
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-400">
            Access completed work, documentation, and project assets
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-4">
            {deliverables.map((deliverable, index) => (
              ...
              >
                <Card
                  glass
                  className="p-6 hover:border-indigo-500/30 transition-all duration-300"
                >
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                              {deliverable.url && (
                                ...
                                >
                                  {deliverable.file_references &&
                                  deliverable.file_references.length > 0 ? (
                                    <>
