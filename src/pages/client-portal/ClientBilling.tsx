...
import { CreditCard, Download, CheckCircle2, Clock, AlertCircle, ExternalLink } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-400">Manage your subscription and view invoices</p>
        </div>
        ...
        {subscription ? (
          <>
            <div className="grid lg:grid-cols-3 gap-6 mb-8">
              <Card glass className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <p className="text-slate-400 text-sm mb-2">Monthly Subscription</p>
              ...
              <Card glass className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-slate-400 text-sm mb-2">Next Billing Date</p>
                    <p className="text-xl font-bold text-white">
                      {stripeHelpers.formatDate(subscription.current_period_end)}
                    </p>
                  </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6 mb-8">
              <Card glass className="lg:col-span-2 p-6">
                ...
                <div className="flex items-start justify-between mb-6">
                  <div>
                    ...
                    <StatusBadge status={subscription.billing_cycle} variant="info" />
                  </div>
                </div>

                {subscription.subscription_plans?.features && (
                  <div className="space-y-3">
                    <p className="text-slate-400 text-sm font-medium mb-3">Plan Features:</p>
              ...
              <Card glass className="p-6">
                <h2 className="text-xl font-bold text-white mb-6">Manage Billing</h2>
                <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-4 flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 mt-2 text-sm text-slate-500">
                          <span>Issued: {stripeHelpers.formatDate(invoice.issue_date)}</span>
                          <span>Due: {stripeHelpers.formatDate(invoice.due_date)}</span>
                          {invoice.paid_date && (
                            <span className="text-[#10B981]">Paid: {stripeHelpers.formatDate(invoice.paid_date)}</span>
                          )}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="text-right mr-4">
                        ...
                        <p className="text-slate-500 text-sm">
                          {stripeHelpers.formatAmount(invoice.subtotal)} + {stripeHelpers.formatAmount(invoice.tax)} tax
                        </p>
                      </div>
