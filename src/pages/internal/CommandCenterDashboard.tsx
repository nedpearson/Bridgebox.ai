    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400 mt-2">
          Super Admin operational flight deck. All telemetry and debugging
          surfaces are isolated from tenant spaces.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Link
          to="/app/internal/recording-center/errors"
          className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-red-500/50 transition-colors group"
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-3xl font-bold text-white">
              {stats.errors + stats.jobs}
            </span>
          </div>
          <h3 className="text-slate-300 font-semibold">Active Errors</h3>
          <p className="text-sm text-slate-500 mt-1">
            Unhandled exceptions & failed jobs
          </p>
        </Link>

        <Link
          to="/app/internal/recording-center/capture"
          className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-purple-500/50 transition-colors group"
        >
          <div className="flex items-center justify-between mb-4">
          ...
          <p className="text-sm text-slate-500 mt-1">
            Bug captures and product demos
          </p>
        </Link>

        <Link
          to="/app/internal/recording-center/logs"
          className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-blue-500/50 transition-colors group"
        >
          <div className="flex items-center justify-between mb-4">
          ...
          <p className="text-sm text-slate-500 mt-1">
            Recent 100 system events
          </p>
        </Link>

        <Link
          to="/app/internal/recording-center/audit"
          className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-indigo-500/50 transition-colors group"
        >
          <div className="flex items-center justify-between mb-4">
          ...
          <p className="text-sm text-slate-500 mt-1">
            Monitoring admin access vectors
          </p>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl">
          ...
          <div className="space-y-3">
            <Link
              to="/app/internal/recording-center/capture"
              className="block p-4 bg-slate-950 border border-slate-800 rounded-lg hover:border-slate-700 text-slate-300 font-medium"
            >
              Record new diagnostic session
            </Link>
            <Link
              to="/app/internal/recording-center/notes"
              className="block p-4 bg-slate-950 border border-slate-800 rounded-lg hover:border-slate-700 text-slate-300 font-medium"
            >
              Draft build or release note
            </Link>
            <Link
              to="/app/internal/recording-center/diagnostics"
              className="block p-4 bg-slate-950 border border-slate-800 rounded-lg hover:border-slate-700 text-slate-300 font-medium"
            >
              Search internal routing maps
            </Link>
          </div>
        </div>
      </div>
