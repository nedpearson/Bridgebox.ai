      ...
      <div className="flex items-end justify-between">
        <div>
          ...
          <p className="text-slate-400">
            Evaluative interface isolating anomaly footprints extracted from
            Tenant Support scopes.
          </p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-16 text-center">
          ...
          <p className="text-slate-500">
            No anomalous traces currently awaiting operational review.
          </p>
        </div>
      ) : (
          ...
          {filtered.map((bug) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <span
                  className={`px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-wider border ${getSeverityStyle(bug.severity)}`}
                >
                  {bug.severity}
                </span>
