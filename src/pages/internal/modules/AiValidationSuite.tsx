...
import {
  validationHarness,
  type TestResult,
} from "../../../lib/ai/testing/validationHarness";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">
            Autonomous adversarial testing of the LLM Intelligence Graph
            boundaries.
          </p>
        </div>
      ...
      <div className="space-y-4">
        ...
        {results.length === 0 && !isRunning && (
          <div className="text-center py-12 text-slate-500 bg-slate-900/50 rounded-lg border border-slate-800">
            Click "Run Full Matrix" to autonomously inject synthetic contexts
            across the Bridgebox model.
          </div>
        )}
