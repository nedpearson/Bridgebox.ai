  ...
  const customSolutions = [
    {
      ...
      description:
        "Tailored applications designed specifically for your business processes and requirements.",
      priceRange: "$25k - $500k+",
    },
    {
      icon: BarChart3,
      ...
      description:
        "Real-time analytics dashboards that consolidate your data and provide actionable insights.",
      priceRange: "$15k - $150k+",
    },
    {
      icon: Smartphone,
      ...
      description:
        "Native iOS and Android apps that extend your business operations to mobile devices.",
      priceRange: "$50k - $300k+",
    },
    {
      icon: Network,
      ...
      description:
        "Complex system integrations connecting your entire technology stack seamlessly.",
      priceRange: "$30k - $250k+",
    },
  ];
    ...
    <div className="pt-20">
      <Section background="gradient" className="pt-32 pb-16 relative">
        ...
        <div className="text-center max-w-4xl mx-auto relative z-10">
          ...
          >
            Enterprise-grade platform subscriptions and bespoke custom
            development.
          </motion.p>
        </div>
      </Section>
          ...
          <div className="border-t border-white/10 pt-20">
            ...
            >
              ...
              <p className="text-xl text-slate-400 max-w-3xl mx-auto mb-6">
                Every system is built to your exact needs. Pricing is based on
                scope, complexity, and integrations.
              </p>
            ...
            >
              <Card glass className="max-w-3xl mx-auto">
                ...
                <p className="text-slate-400 mb-6 leading-relaxed">
                  Our team will analyze your requirements and provide a detailed
                  proposal with transparent pricing, timelines, and
                  deliverables.
                </p>
                  ...
                  {PLANS.filter((p) => p.tier !== "custom").map((plan) => (
                    <th key={plan.id} className="text-center py-4 px-6">
                      ...
                      <div className="text-indigo-500 text-sm mt-1">
                        {formatPlanPrice(plan, "monthly")}/mo
                      </div>
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {[
                  ...
                  },
                  {
                    ...
                    values: ["Core", "Advanced", "Full Access"],
                  },
                  {
                    name: "Support",
                    values: ["Email", "Priority", "Dedicated Team"],
                  },
                  {
                    name: "Security & Compliance",
                    values: ["Standard", "Advanced", "Enterprise"],
                  },
                  {
                    name: "Analytics",
                    values: ["Monthly", "Real-time", "Advanced Suite"],
                  },
                  ...
                  <tr
                    key={row.name}
                    className={`border-b border-slate-800/50 ${index % 2 === 0 ? "bg-slate-900/30" : ""}`}
                  >
      ...
      <Section background="gradient">
        ...
        >
          ...
          <p className="text-xl text-slate-300 mb-8 leading-relaxed">
            Talk to our team to find the perfect solution for your business
            needs.
          </p>
