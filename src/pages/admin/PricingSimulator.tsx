  ...
  return (
    <>
      <AppHeader
        ...
        subtitle="Internal Sales quoting tool and revenue modeler"
      />
      ...
      <div className="p-8 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {INTEGRATIONS.map((i) => (
                    ...
                    >
                      {i}
                      {config.integrations.includes(i) && (
              ...
              <div>
                <label className="flex items-center space-x-3 p-4 bg-slate-900/50 border border-slate-800 rounded-xl cursor-pointer hover:bg-slate-800 transition-colors">
                  <input
                    ...
                    onChange={(e) =>
                      setConfig({ ...config, mobile: e.target.checked })
                    }
                    className="form-checkbox h-5 w-5 text-indigo-500 bg-slate-800 border-slate-700 rounded"
                  />
                  <div>
                    ...
                    <span className="block text-sm text-slate-400">
                      Provisions a compiled field-app alongside the web
                      dashboard.
                    </span>
                  </div>
                </label>
          ...
          <div className="space-y-6">
            <Card
              glass
              className="p-6 border-indigo-500/30 shadow-[0_0_30px_rgba(99,102,241,0.1)] relative overflow-hidden"
            >
                ...
                <div className="flex justify-between items-end border-b border-slate-800 pb-4">
                  ...
                  <div className="text-right">
                    <span className="text-3xl font-bold text-white">
                      ${pricing.monthlyMsrp.toLocaleString()}
                    </span>
                ...
                <div className="flex justify-between items-end border-b border-slate-800 pb-4">
                  ...
                  <div className="text-right">
                    <span className="text-xl font-bold text-emerald-400">
                      ${pricing.annualMsrp.toLocaleString()}
                    </span>
              ...
              <Button
                ...
                className="w-full mt-8 flex items-center justify-center bg-indigo-600 hover:bg-indigo-500"
              >
                {copiedLink ? (
                ...
                <div className="bg-slate-950 rounded-lg p-4 border border-slate-800">
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-white font-bold">
                      ${pricing.monthlyCogs.toLocaleString()} / mo
                    </span>
                  </div>
                  <div className="text-xs text-slate-500">
                    Includes Infra, Integrations, and AI Tokens
                  </div>
                </div>

                <div
                  className={`rounded-lg p-4 border ${pricing.marginStatus === "Healthy" ? "bg-emerald-500/10 border-emerald-500/30" : pricing.marginStatus === "Warning" ? "bg-amber-500/10 border-amber-500/30" : "bg-red-500/10 border-red-500/30"}`}
                >
                  <div className="flex justify-between items-center mb-1">
                    <span
                      className={`text-sm font-black uppercase ${pricing.marginStatus === "Healthy" ? "text-emerald-400" : pricing.marginStatus === "Warning" ? "text-amber-400" : "text-red-400"}`}
                    >
                      Gross Margin
                    </span>
                    <span
                      className={`text-2xl font-black ${pricing.marginStatus === "Healthy" ? "text-emerald-400" : pricing.marginStatus === "Warning" ? "text-amber-400" : "text-red-400"}`}
                    >
                  ...
                  {pricing.marginStatus !== "Healthy" && (
                    <div className="flex items-start mt-2 text-xs text-red-300">
                      ...
                      This configuration is dangerously close to unprofitable
                      due to high COGS limits.
                    </div>
                  )}
                </div>
              </div>
