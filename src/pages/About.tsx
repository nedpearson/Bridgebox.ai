...
export default function About() {
  const principles = [
    {
      ...
      title: "Our Mission",
      description:
        "Bridge gaps between systems using intelligent AI infrastructure",
      color: "#3B82F6",
    },
    {
      icon: Eye,
      title: "Our Vision",
      description:
        "A future where businesses operate as fully connected systems",
      color: "#10B981",
    },
  ];
  ...
  const timeline = [
    {
      ...
      title: "Foundation",
      description:
        "Bridgebox founded to solve enterprise integration challenges",
    },
    {
      year: "2022",
    ...
    },
    {
      ...
      title: "Global Leader",
      description:
        "Expanded to 47 countries, processing 10B+ operations monthly",
    },
    {
      year: "2025+",
      title: "The Future",
  ...
  const futureVision = [
    ...
    },
    {
      ...
      description:
        "Fully autonomous business processes that require no human intervention",
    },
    {
      icon: TrendingUp,
      title: "Predictive Intelligence",
      description:
        "AI that anticipates needs and optimizes before problems arise",
    },
    {
      icon: Sparkles,
    ...
    <>
        ...
        <div className="max-w-5xl mx-auto mb-32">
          ...
          >
            <p className="text-2xl font-light text-white">
              The average enterprise uses over 110 software tools. Yet despite
              this abundance, businesses still struggle with manual work,
              disconnected data, and inefficient processes.
            </p>
            <p>
              The problem isn't a lack of technology. It's the gaps between
              systems. These disconnections create friction, introduce errors,
            ...
            <p>
              We build AI infrastructure that bridges every gap, automates every
              workflow, and connects every data source. The result is a business
              that operates as one seamless, intelligent system.
            </p>
          </motion.div>
        </div>
          ...
          {timeline.map((milestone, index) => (
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                ...
                <div className="text-2xl font-bold text-indigo-500 md:text-right">
                  {milestone.year}
                </div>
              </div>
            </motion.div>
      ...
      <Section background="dark">
        <div className="text-center mb-16">
          ...
          >
            We're building toward a world where businesses operate as
        ...
        >
          <Card glass className="max-w-4xl mx-auto">
            <p className="text-2xl font-light text-white leading-relaxed">
              "The future belongs to businesses that can adapt, evolve, and
              operate at machine speed. We're building the infrastructure that
