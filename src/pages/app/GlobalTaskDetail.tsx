...
export default function GlobalTaskDetail() {
  ...
  const [task, setTask] = useState<
    (GlobalTask & { assignee?: any; creator?: any }) | null
  >(null);
  ...
  const handleStatusChange = async (newStatus: string) => {
    ...
    try {
      await globalTasksService.updateTask(task.id, {
                ...
                <div>
                  ...
                  <div className="bg-slate-800/50 p-4 rounded-lg border border-slate-700 space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-white text-sm">
                        {task.creator?.full_name || "System Generated"}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-400 text-sm flex items-center">
                      ...
                      <span className="text-white text-sm">
                        {formatDetailedTime(task.created_at)}
                      </span>
                    </div>
                    {task.due_date && (
