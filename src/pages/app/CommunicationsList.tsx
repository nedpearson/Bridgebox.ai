...
export default function CommunicationsList() {
  ...
  usePlatformIntelligence({
    ...
    type: "page",
    description:
      "Centralized view of all inbound and outbound email, calls, and messages synced natively to Bridgebox components.",
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        const data =
          await globalCommunicationsService.getTenantCommunications(tenantId);
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400">
            Unified logging and interaction traces across all synced operations.
          </p>
        </div>
