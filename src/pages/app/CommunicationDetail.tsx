...
export default function CommunicationDetail() {
  ...
  const [comm, setComm] = useState<
    (GlobalCommunication & { author?: any }) | null
  >(null);
  ...
  return (
    <>
      <AppHeader
        title={comm.subject || "Communication Trace"}
        subtitle={`Log ID: ${comm.id.slice(0, 8)}`}
      />
      ...
      <RelationalCommandCenter entityType="communication" entityId={comm.id}>
        <div className="max-w-4xl mx-auto py-8">
          <Link
            ...
            className="flex items-center space-x-2 text-slate-400 hover:text-white mb-6"
          >
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex space-x-3">
                ...
                <StatusBadge
                  ...
                  variant={comm.direction === "inbound" ? "success" : "warning"}
                />
              </div>
            </div>
                  ...
                  <div className="bg-slate-800/50 p-4 rounded-lg border border-slate-700 space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-white text-sm">
                        {comm.author?.full_name || "System Generated"}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-400 text-sm flex items-center">
