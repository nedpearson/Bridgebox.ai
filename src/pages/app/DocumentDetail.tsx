              ...
              <div className="mt-6 pt-6 border-t border-slate-800">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <span
                      className={`inline-flex items-center px-2.5 py-1 text-xs font-medium rounded-full border ${document.status === "completed" ? "bg-green-500/10 text-green-400 border-green-500/20" : "bg-amber-500/10 text-amber-400 border-amber-500/20"}`}
                    >
                      {document.status}
                    </span>
                  </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-slate-800">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {document.tags.map((tag, index) => (
                        <span
                          key={index}
                          className="inline-flex items-center px-2.5 py-1 text-xs font-medium rounded-full bg-slate-500/10 text-slate-400 border border-slate-500/20"
                        >
                          {tag}
                        </span>
                      ))}
            ...
            {analysis && (
              <>
                ...
                {analysis.key_entities &&
                  Object.keys(analysis.key_entities).length > 0 && (
                    <Card className="p-6 bg-slate-900/50 border-slate-800">
                      <h3 className="text-lg font-semibold text-white mb-4">
                        Key Entities
                      </h3>
                      ...
                      <div className="space-y-4">
                        {analysis.key_entities.people &&
                          analysis.key_entities.people.length > 0 && (
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2">
                                {analysis.key_entities.people
                                  ...
                                  .map((person, index) => (
                                    <span
                                      key={index}
                                      className="inline-flex items-center px-2.5 py-1 text-xs font-medium rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20"
                                    >
                                      {person}
                                    </span>
                                  ))}
                        ...
                        {analysis.key_entities.organizations &&
                          analysis.key_entities.organizations.length > 0 && (
                            <div>
                              <div className="flex items-center gap-2 text-sm text-slate-400 mb-2">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {analysis.key_entities.organizations
                                  ...
                                  .map((org, index) => (
                                    <span
                                      key={index}
                                      className="inline-flex items-center px-2.5 py-1 text-xs font-medium rounded-full bg-purple-500/10 text-purple-400 border border-purple-500/20"
                                    >
                                      {org}
                                    </span>
                                  ))}
                        ...
                        {analysis.key_entities.dates &&
                          analysis.key_entities.dates.length > 0 && (
                            <div>
                              <div className="flex items-center gap-2 text-sm text-slate-400 mb-2">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {analysis.key_entities.dates
                                  ...
                                  .map((date, index) => (
                                    <span
                                      key={index}
                                      className="inline-flex items-center px-2.5 py-1 text-xs font-medium rounded-full bg-amber-500/10 text-amber-400 border border-amber-500/20"
                                    >
                                      {date}
                                    </span>
                                  ))}
                        ...
                        {analysis.key_entities.amounts &&
                          analysis.key_entities.amounts.length > 0 && (
                            <div>
                              <div className="flex items-center gap-2 text-sm text-slate-400 mb-2">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {analysis.key_entities.amounts
                                  ...
                                  .map((amount, index) => (
                                    <span
                                      key={index}
                                      className="inline-flex items-center px-2.5 py-1 text-xs font-medium rounded-full bg-green-500/10 text-green-400 border border-green-500/20"
                                    >
                        ...
                        {analysis.key_entities.locations &&
                          analysis.key_entities.locations.length > 0 && (
                            <div>
                              <div className="flex items-center gap-2 text-sm text-slate-400 mb-2">
