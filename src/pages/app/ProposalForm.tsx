  ...
  return (
    <>
      <AppHeader
        ...
        subtitle="Generate a new client proposal"
      />
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        lead_id: e.target.value || undefined,
                      })
                    }
                    className="w-full bg-slate-800/50 border border-slate-700 rounded-lg px-4 py-3 text-white"
                  >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {serviceTypeOptions.map((service) => (
                      <button
                        ...
                        type="button"
                        onClick={() => {
                          const updated = formData.service_types.includes(
                            service,
                          )
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        pricing_amount: parseFloat(e.target.value),
                      })
                    }
                    className="w-full bg-slate-800/50 border border-slate-700 rounded-lg px-4 py-3 text-white"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        timeline_estimate: e.target.value,
                      })
                    }
                    className="w-full bg-slate-800/50 border border-slate-700 rounded-lg px-4 py-3 text-white"
                  />
