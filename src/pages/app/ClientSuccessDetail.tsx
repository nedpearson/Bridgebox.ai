...
export default function ClientSuccessDetail() {
  ...
  const loadClientData = async () => {
    ...
    try {
      ...
      const [overviewData, interactionsData, opportunitiesData, risksData] =
        await Promise.all([
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-white font-medium">
                    {overview.account_owner.owner_profile?.full_name ||
                      "Unassigned"}
                  </div>
                </div>
              </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            {overview.health_score && (
              <HealthScoreCard score={overview.health_score} />
            )}
                            ...
                            <div className="text-xs text-slate-500 mt-2">
                              ...
                              {risk.assigned_to_profile && (
                                <>
                                  {" "}
                                  • Assigned to{" "}
                                  {risk.assigned_to_profile.full_name}
                                </>
                              )}
                            </div>
                          </div>
