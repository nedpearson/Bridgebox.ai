        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center space-x-3 w-full sm:w-auto">
              ...
              {!isEditing ? (
                <Button
                  ...
                  variant="outline"
                  className="flex-1 sm:flex-none bg-slate-800/50 hover:bg-slate-700"
                >
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <Card
                glass
                className="p-0 border-indigo-500/20 shadow-indigo-500/10"
              >
                <div className="p-6 border-b border-white/5 pb-4">
                  <h3 className="text-xl font-bold text-white">
                    Generative Charter & Drafting
                  </h3>
                </div>
                <GenerativeDraftingStudio
                  documentId={project.id}
                  initialContent={
                    project.notes || "<p>Start drafting your document...</p>"
                  }
        ...
        {showQR && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              <Card
                glass
                className="p-8 border-indigo-500/30 shadow-2xl relative"
              >
                <button
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-slate-400">
                    Scan this QR code with any mobile device to instantly open
                    the field agent view for this specific project.
                  </p>
                </div>
