  ...
  async function loadOpportunities() {
    ...
    try {
      const [summaryRes, rankedRes] = await Promise.all([
        opportunityAnalyzer.generateHotOpportunitiesSummary(
          currentOrganization.id,
        ),
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Identify where to focus next for strategic growth
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              ...
              <p className="text-xs text-gray-500 mt-1">
                {
                  allOpportunities.filter((o) => o.opportunity_level === "high")
                    .length
                }{" "}
                high priority
              </p>
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              onChange={(e) =>
                setFilter({
                  ...filter,
                  level: (e.target.value as OpportunityLevel) || undefined,
                })
              }
              className="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
