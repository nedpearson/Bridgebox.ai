      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-2">
                  App Name (For Homescreen iOS/Android)
                </label>
                <input
                  type="text"
                  value={appConfig.appName}
                  onChange={(e) =>
                    setAppConfig({ ...appConfig, appName: e.target.value })
                  }
              ...
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-2">
                  Short Name (Required for limits via Web Manifest)
                </label>
                <input
                  type="text"
                  ...
                  maxLength={12}
                  onChange={(e) =>
                    setAppConfig({ ...appConfig, shortName: e.target.value })
                  }
                  className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-indigo-500"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setAppConfig({ ...appConfig, themeColor: e.target.value })
                    }
          ...
          <Card>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div
                  onClick={() =>
                    setAppConfig({ ...appConfig, navigationStyle: "bottom" })
                  }
                ...
                <div
                  onClick={() =>
                    setAppConfig({ ...appConfig, navigationStyle: "sidebar" })
                  }
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-slate-700">
                <input
                  ...
                  onChange={(e) =>
                    setAppConfig({ ...appConfig, showSplash: e.target.checked })
                  }
                ...
                <label className="text-sm text-slate-300">
                  Generate PWA Native Splash Screens on load
                </label>
              </div>
            </div>
          </Card>
          ...
          <Card>
            ...
            <p className="text-sm text-slate-400 mb-6">
              Track active staff installations and configure offline ingestion
              queues.
            </p>
              ...
              <div className="bg-slate-900 border border-slate-700/50 rounded-lg p-4 flex items-center justify-between">
                <div>
                  <div className="text-white font-medium flex items-center">
                    ...
                    Active FCM/APNs Device Tokens
                  </div>
                  <div className="text-xs text-slate-500 mt-1">
                    Bridgebox natively supports high-scale push delivery.
                  </div>
                </div>
              ...
              <div className="bg-slate-900 border border-slate-700/50 rounded-lg p-4 flex items-center justify-between opacity-70">
                <div>
                  <div className="text-white font-medium">
                    Pending Offline Sync Tasks
                  </div>
                  <div className="text-xs text-slate-500 mt-1">
                    Mutations awaiting reconnection across all devices.
                  </div>
                </div>
        ...
        <div className="lg:col-span-5 flex justify-center sticky top-6 self-start">
          <div className="relative">
            ...
            <div
              className="w-[320px] h-[650px] bg-black rounded-[40px] shadow-2xl border-[12px] border-black overflow-hidden relative"
            ...
            >
              ...
              <div
                className="absolute top-0 inset-x-0 h-24 pt-8 px-4 flex items-center justify-between z-40 transition-colors"
                style={{ backgroundColor: appConfig.themeColor }}
              >
                {appConfig.navigationStyle === "sidebar" && (
                  <Menu className="w-5 h-5 text-white/90" />
                )}
                <h1 className="text-white font-semibold flex-1 text-center text-sm truncate px-2">
                  {appConfig.appName}
                </h1>
                {
                  appConfig.navigationStyle === "sidebar" && (
              ...
              {appConfig.navigationStyle === "bottom" && (
                <div className="absolute bottom-0 inset-x-0 h-20 bg-slate-900 border-t border-white/10 flex justify-around items-center px-4 pb-4 z-40">
                  <div className="flex flex-col items-center gap-1 opacity-100">
                    <Navigation2
                      className="w-5 h-5"
                      style={{ color: appConfig.themeColor }}
                    />
                    <div
