...
export default function CaseStudyDetail() {
  ...
  const relatedCaseStudies = getFeaturedCaseStudies(3).filter(
    (cs) => cs.slug !== slug,
  );
      ...
      <Section background="gradient">
        ...
        >
          ...
          <p className="text-xl text-slate-300 mb-8 leading-relaxed">
            Let's discuss how custom software, operational dashboards, mobile
            applications, and intelligent automation can transform your
            operations.
          </p>
