...
export default function Review() {
  const { onboardingData, completeOnboarding, setCurrentStep } =
    useOnboarding();
  ...
  const sections = [
    {
      ...
      items: [
        ...
        {
          label: "Company Size",
          value: getCompanySizeLabel(onboardingData.company_size),
        },
        { label: "Website", value: onboardingData.website || "Not provided" },
        {
          label: "Primary Contact",
          value: onboardingData.primary_contact_name,
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Accounting",
          value: onboardingData.current_systems.accounting || "None",
        },
        {
          label: "Document Management",
          value: onboardingData.current_systems.document_management || "None",
        },
        {
          label: "Spreadsheets",
          value: onboardingData.current_systems.spreadsheets
            ? "Heavy use"
            : "Not significant",
        },
        {
          label: "Internal Dashboards",
          value: onboardingData.current_systems.internal_dashboards
            ? "Yes"
            : "No",
        },
      ],
    ...
    },
    {
      ...
      items: [
        { label: "Timeline", value: getTimelineLabel(onboardingData.timeline) },
        {
          ...
          value: onboardingData.additional_notes || "None",
        },
      ],
    },
  ];
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="text-sm text-slate-300 space-y-2">
                ...
                <li>
                  • You'll receive a personalized consultation call invitation
                </li>
                <li>
                  • We'll prepare initial recommendations based on your needs
                </li>
