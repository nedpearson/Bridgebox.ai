      ...
      <div className="flex-1 p-6 overflow-y-auto">
        ...
        {isAnalyzing ? (
          ...
          <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-800 border-dashed text-slate-500 text-sm text-center max-w-md mt-12 mx-auto">
            Competitor data will populate dynamically against your firm's
            baseline.
          </div>
        ) : (
          <div className="space-y-6 animate-fade-in max-w-4xl">
              ...
              <table className="w-full text-left text-sm whitespace-nowrap">
                <thead className="bg-slate-900">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-indigo-400 font-medium">
                      Your Firm
                    </th>
                    <th className="px-4 py-3 text-slate-400 font-medium tracking-wide">
                      Competitor 1
                    </th>
                  </tr>
                </thead>
            ...
            <div className="p-5 bg-indigo-600/10 border border-indigo-500/20 rounded-xl">
              ...
              <p className="text-sm text-slate-300 leading-relaxed max-w-2xl">
                Competitor analysis reveals a distinct gap in "Automated Client
                Portals". Bridgebox will prioritize a secure portal environment
                in the Blueprint phase, instantly differentiating your brand in
                the market.
              </p>
