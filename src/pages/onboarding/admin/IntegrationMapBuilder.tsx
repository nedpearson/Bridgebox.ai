    ...
    <div className="max-w-5xl mx-auto animate-fade-in space-y-8">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-white mb-2">
          Integration Network Mapping
        </h2>
        <p className="text-slate-400">
          Manage required external APIs mapped against Bridgebox architectural
          entities.
        </p>
      </div>
        ...
        <div className="bg-slate-900 border border-emerald-500/20 rounded-2xl p-6 relative overflow-hidden group">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Automates Retainer Agreement dispatch on Case approval events.
                </p>
              </div>
            </div>
          ...
          <div className="mt-4 pt-4 border-t border-slate-800 flex items-center space-x-6 text-sm">
            <div className="flex items-center text-slate-300">
              <LinkIcon className="w-4 h-4 mr-2" /> Connected to:{" "}
              <span className="font-medium text-emerald-400 ml-1">
                retainers
              </span>
            </div>
            <div className="flex items-center text-slate-300">
              <Zap className="w-4 h-4 mr-2" /> Triggers:{" "}
              <span className="font-medium text-emerald-400 ml-1">1</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-900 border border-amber-500/20 rounded-2xl p-6 relative overflow-hidden group">
          ...
          <div className="flex justify-between items-start">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Process billable invoices and manage automated retainer
                  subscriptions.
                </p>
              </div>
            </div>
          ...
          <div className="mt-4 pt-4 border-t border-slate-800 flex items-center justify-between text-sm">
            <div className="flex items-center text-amber-500">
              <AlertTriangle className="w-4 h-4 mr-2" /> Keys Not Provided — AI
              build will pause Stripe entity relationships natively.
            </div>
          </div>
        </div>
      </div>
