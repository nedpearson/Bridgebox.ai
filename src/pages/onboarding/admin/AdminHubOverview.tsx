    ...
    <div className="space-y-8 animate-fade-in max-w-5xl mx-auto">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-white mb-2">
          {session?.session_title || "Executive Overview"}
        </h2>
        <p className="text-slate-400">
          Review the autonomous AI system ingestion for the active client
          onboarding profile natively.
        </p>
      </div>
        ...
        <div className="p-6 space-y-4">
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="text-white text-sm font-medium">
                  Phase 1: Relational Core Scaffold
                </p>
                <p className="text-xs text-slate-400">
                  Generates pure PostgREST definitions enforcing Row Level
                  Security.
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-slate-950 rounded-xl border border-slate-800">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-white text-sm font-medium">
                  Phase 2: React Component Mappings
                </p>
                <p className="text-xs text-slate-400">
                  Engineers the Frontend logic executing the CRUD architecture.
                </p>
              </div>
            </div>
