        ...
        {loading ? (
          ...
          <Card glass className="p-8">
            <div className="text-center mb-8">
              <div className="w-16 h-16 bg-gradient-to-br from-[#3B82F6] to-[#10B981] rounded-2xl flex items-center justify-center mx-auto mb-6">
                <Sparkles className="w-8 h-8 text-white" />
              </div>
              <h1 className="text-2xl font-bold text-white mb-2">You're Invited!</h1>
              <p className="text-slate-400">
                Join <span className="text-white font-semibold">{invitation.organization_name}</span> on Bridgebox
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6 mb-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-white font-medium">{invitation.organization_name}</span>
              </div>
            </div>
            ...
            {!user ? (
              <div className="space-y-3">
                ...
                <Button
                  variant="outline"
                  onClick={() => navigate(`/signup?redirect=/invitations/accept?token=${token}`)}
                  className="w-full"
                >
                  Create Account
                </Button>
