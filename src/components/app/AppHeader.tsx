      ...
      <div className="border-b border-slate-800 bg-slate-900 sticky top-0 z-40">
        <div className="px-4 md:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3 md:space-x-4">
            ...
            <div>
              {backTo && (
                <Link
                  to={backTo}
                  className="inline-flex items-center text-xs font-semibold text-slate-400 hover:text-indigo-400 transition-colors uppercase tracking-widest mb-1.5 group"
                >
          ...
          <div className="flex items-center space-x-3 md:space-x-4">
            ...
            <Link
              to="/app/settings"
              className="flex items-center space-x-2 pl-3 border-l border-slate-800 hover:bg-white/5 p-2 -my-2 rounded-lg cursor-pointer transition-colors"
            >
              ...
              <div className="hidden md:block text-left">
                <p className="text-sm font-medium text-white leading-tight hover:text-indigo-400 transition-colors">
