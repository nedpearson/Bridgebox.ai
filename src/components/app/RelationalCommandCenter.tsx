...
export default function RelationalCommandCenter({
  entityType,
  entityId,
  children,
}: RelationalCommandCenterProps) {
  ...
  React.useEffect(() => {
    ...
    return () =>
      window.removeEventListener("command-center-tab", handleTabChange);
  }, []);
    ...
    actions: [
      {
        ...
        description:
          "Use the Command Palette (Cmd+K) to globally create new Tasks, Projects, and Clients",
      },
      {
        id: "network_link",
        type: "navigation",
        ...
        description:
          "Navigate to the Network tab to seamlessly link N-degree N-tier topological entities together",
      },
      {
        id: "nba_review",
        type: "navigation",
        ...
        description:
          "Review the Next Best Actions and Blockers panel on the Overview tab to intelligently orchestrate the platform.",
      },
      {
        id: "upload_file",
        type: "mutation",
        name: "Relational Uploads",
        description:
          "Upload relational files bounded natively to this context via the Documents tab",
      },
      {
        id: "log_interaction",
        type: "mutation",
        ...
        description:
          "Log phone calls, emails, and physical interactions on the Comms tab to create persistent system traces",
      },
    ],
  });
