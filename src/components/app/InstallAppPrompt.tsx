...
export default function InstallAppPrompt() {
  ...
  const handleInstallClick = async () => {
    ...
    if (deferredPrompt) {
      ...
      alert(
        "Installation is managed via your browser setting icon (usually top right corner of the address bar), or the app is already installed.",
      );
    }
  };
        ...
        {showMobileModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              <Card
                glass
                className="p-8 border-indigo-500/30 shadow-2xl relative text-center"
              >
                <button
                ...
                <p className="text-sm text-slate-400 mb-6">
                  Scan this QR code with your iPhone or Android camera to
                  instantly open and install the mobile version natively.
                </p>
                ...
                <div className="mt-6 flex flex-col items-center gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-xs text-slate-500">
                      Follow the standard Install prompts
                    </p>
                  </div>
                </div>
              </Card>
        ...
        {showIosInstruction && (
          <div className="fixed inset-0 z-[100] flex flex-col justify-end p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              <Card
                glass
                className="p-6 border-indigo-500/30 shadow-2xl relative text-center bg-slate-900/95"
              >
                <button
                ...
                <p className="text-sm text-slate-300 mb-4">
                  Install Bridgebox securely onto your iPhone for full-screen
                  App access natively.
                </p>

                <div className="bg-slate-800/50 text-left p-4 rounded-lg space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded bg-slate-700 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">
                      1
                    </div>
                    <p className="text-sm text-slate-300 pointer-events-none">
                      Tap the{" "}
            ...
            >
              <span className="text-sm font-bold tracking-widest uppercase mb-2 shadow-black drop-shadow-lg">
                Tap Here
              </span>
              <svg
