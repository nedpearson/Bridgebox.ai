...
const routeGroups = [
  {
    baseMatch: ['/app/projects', '/app/tasks', '/app/documents', '/app/communications'],
    tabs: [
  ...
  {
    baseMatch: ['/app/clients', '/app/leads', '/app/proposals', '/app/pipeline', '/app/opportunities'],
    tabs: [
  ...
  {
    baseMatch: ['/app/analytics', '/app/trends', '/app/conversions', '/app/data-activity'],
    tabs: [
...
export default function SubNav() {
  ...
  const activeGroup = routeGroups.find(group => 
    group.baseMatch.some(match => location.pathname === match || location.pathname.startsWith(`${match}/`))
  );
