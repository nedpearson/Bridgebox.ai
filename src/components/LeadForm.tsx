    ...
    return (
      ...
      >
        ...
        <p className="text-slate-400 max-w-md mx-auto">
          We have received your inquiry and will get back to you within 24
          hours.
        </p>
      </motion.div>
    );
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                lead_type: e.target.value as LeadSubmission["lead_type"],
              })
            }
          ...
          >
            ...
            <option value="dashboard_analytics">
