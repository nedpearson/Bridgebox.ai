...
export default function ProductDashboard() {
  ...
  const insights = [
    {
      type: "optimization",
      title: "Workflow efficiency can be improved",
      description:
        "Invoice processing can be 15% faster with parallel execution",
      impact: "high",
    },
    {
      type: "alert",
      title: "Data sync delay detected",
      description: "Shopify connection experiencing minor latency",
      impact: "medium",
    },
    {
      type: "success",
      title: "Peak performance achieved",
      description: "System running at optimal capacity",
      impact: "positive",
    },
  ];
          ...
          {kpis.map((kpi, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 text-xs">
                <span
                  className={
                    kpi.trend > 0 ? "text-[#10B981]" : "text-[#EF4444]"
                  }
                >
                  {kpi.trend > 0 ? "+" : ""}
                  {kpi.trend}%
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-slate-500">
                      {workflow.processed.toLocaleString()} /{" "}
                      {workflow.total.toLocaleString()}
                    </span>
                  </div>
                  <div className="ml-5">
                ...
                <div className="flex items-start gap-3 mb-3">
                  ...
                  >
                    {insight.type === "optimization" && (
                      <ArrowUpRight
                        className="w-4 h-4"
                        style={{ color: impactColor(insight.impact) }}
                      />
                    )}
                    {insight.type === "alert" && (
                      <AlertCircle
