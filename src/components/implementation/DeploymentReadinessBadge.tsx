...
const READINESS_CONFIG: Record<DeploymentReadiness, { label: string; className: string }> = {
  not_ready: {
    label: 'Not Ready',
...
export default function DeploymentReadinessBadge({ readiness, size = 'md' }: DeploymentReadinessBadgeProps) {
