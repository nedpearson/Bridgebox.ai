...
const PHASE_CONFIG: Record<DeploymentPhase, { label: string; className: string }> = {
  setup: {
    label: 'Setup',
...
export default function DeploymentPhaseBadge({ phase, size = 'md' }: DeploymentPhaseBadgeProps) {
