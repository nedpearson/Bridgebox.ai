...
export default function SparklineCard({
  ...
  return (
    <div className="relative overflow-hidden bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 group hover:border-indigo-500/30 transition-all duration-300">
