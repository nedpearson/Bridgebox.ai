    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
          See It Compile. Instantly.
        </h2>
        <p className="text-xl text-slate-400 mb-12 leading-relaxed">
          Experience the OS Generation engine locally without creating an
          account. Watch Bridgebox write a custom frontend schema in real-time.
        </p>
        ...
        <div className="bg-slate-900 border border-white/10 rounded-[2rem] p-2 shadow-2xl overflow-hidden relative min-h-[400px]">
          <AnimatePresence mode="wait">
            ...
            {demoState === "idle" && (
              ...
              >
                <div
                  className="w-20 h-20 bg-indigo-500/20 rounded-full flex items-center justify-center mb-6 cursor-pointer hover:bg-indigo-500/40 hover:scale-110 transition-all shadow-[0_0_30px_rgba(99,102,241,0.3)]"
                ...
                <p className="text-slate-400">
                  Initialize a simulated 'Logistics' Enterprise OS Payload.
                </p>
              </motion.div>
            )}
            ...
            {demoState === "complete" && (
              ...
              >
                <div className="w-20 h-20 bg-emerald-500/20 rounded-full flex items-center justify-center mb-6 shadow-[0_0_40px_rgba(16,185,129,0.3)]">
                  <Play className="w-8 h-8 text-emerald-400 transform rotate-90" />{" "}
                  {/* Just a visual check icon analog */}
                </div>
                <h3 className="text-3xl font-bold text-white mb-4">
                  Compilation Successful
                </h3>
                <p className="text-slate-400 mb-8 max-w-sm">
                  A 'Logistics-Tier' operational architecture has been compiled
                  in memory. In production, this permanently replaces your blank
                  workspace.
                </p>
                <div className="flex gap-4">
                  <Button size="lg" to="/sales-onboarding">
                    Build For Real <ArrowRight className="w-4 h-4 ml-2" />
                  </Button>
                  <Button
                    size="lg"
                    variant="outline"
