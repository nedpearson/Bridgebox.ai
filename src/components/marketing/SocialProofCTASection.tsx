...
export default function SocialProofCTASection() {
  const testimonials = [
    {
      quote:
        " Bridgebox didn't sell us a generic tool. They instantaneously generated a logistics platform that perfectly matched our dispatching parameters. ",
      author: "Sarah J.",
    ...
    {
      quote:
        " We deleted 4 different SaaS subscriptions the exact day we ran the Bridgebox compilation wizard. It holds our data natively and securely. ",
      author: "Marcus T.",
      ...
      <Section background="darker" className="py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400">
            Generative operations are replacing legacy architecture everywhere.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-12 opacity-40 grayscale">
          <div className="text-2xl font-black text-slate-500 tracking-tighter">
            FORWARD<span className="text-slate-300">LOGISTICS</span>
          </div>
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-5xl lg:text-7xl font-bold text-white mb-6 tracking-tight">
              Generate Your System Now.
            </h2>
            <p className="text-xl text-slate-300 mb-10 leading-relaxed max-w-2xl mx-auto">
              Stop buying generic software licenses. Tell Bridgebox exactly what
              your industry requires, and deploy a bespoke, highly-performant OS
              in minutes.
            </p>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <Button
                size="lg"
                to="/sales-onboarding"
                className="shadow-[0_0_30px_rgba(99,102,241,0.5)]"
              >
                Build My Exact System <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </div>
            <p className="mt-6 text-sm text-slate-400">
              Multi-Tenant PostgreSQL • Native Mobile Sync • GPT-4o Embedded
            </p>
          </motion.div>
        </div>
      </Section>
