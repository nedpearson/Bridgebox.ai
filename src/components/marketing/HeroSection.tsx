...
export default function HeroSection() {
  return (
    <Section
      background="gradient"
      className="pb-16 pt-32 relative overflow-hidden"
    >
      <GridPattern />
      <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="relative">
          ...
          >
            ...
            >
              Bridgebox generates your workflows, dashboards, mobile apps, and
              AI automation—tailored precisely to your industry format without
            ...
            >
              <Button
                size="lg"
                to="/sales-onboarding"
                className="shadow-[0_0_30px_rgba(99,102,241,0.5)] bg-indigo-500 hover:bg-indigo-600 border border-indigo-500"
              >
            ...
            <motion.div
              ...
              className="mt-10 pt-8 border-t border-white/5 flex flex-wrap items-center justify-start gap-8"
            >
