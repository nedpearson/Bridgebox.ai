  ...
  const steps = [
    {
      ...
      description:
        "Select your operational context (Law, Accounting, Logistics, Retail) to load baseline schemas instantly.",
    },
    {
      id: 2,
      icon: Puzzle,
      ...
      description:
        "Toggle B2B SaaS, marketplace mechanics, or field services. Bridgebox rewrites the UI on the fly.",
    },
    {
      id: 3,
      icon: Network,
      ...
      description:
        "Bind existing systems like Stripe or QuickBooks into our background webhook synchronizer.",
    },
    {
      id: 4,
      icon: Rocket,
      ...
      description:
        "Generate web dashboards, mobile dispatcher apps, and AI agents instantly.",
    },
  ];
    ...
    >
      <div className="text-center mb-16 relative z-10">
        ...
        <p className="text-lg text-slate-400 max-w-2xl mx-auto">
          From concept to functioning Enterprise OS in 4 visual steps.
        </p>
      </div>
