...
export default function PricingClaritySection() {
  const dynamicFactors = [
    {
      label: "Industry Module Complexity",
      desc: "Baseline database footprint and relational maps.",
    },
    {
      label: "Dedicated AI Agents",
      desc: "Number of autonomous Copilot synapses deployed.",
    },
    {
      label: "Mobile PWA Requirements",
      desc: "Staff App vs Customer VIP Portal routing.",
    },
    {
      label: "Integration Sync Load",
      desc: "Webhook processing volume (Stripe, Quickbooks).",
    },
  ];
    ...
    <Section background="dark" className="py-24 border-b border-white/5">
      <div className="text-center mb-16">
        <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
          Transparent, Compiled Pricing.
        </h2>
        <p className="text-xl text-slate-400 max-w-2xl mx-auto">
          You don't pay for bloat. The onboarding generator physically
          calculates your operational footprint and renders exact pricing before
          deploying.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto items-center">
        ...
        >
          ...
          <p className="text-slate-400 mb-8">
            The foundational engine required to host your custom PostgreSQL
            tenant and React applications.
          </p>
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-slate-400 leading-relaxed mb-6">
              Your final MRR is calculated deterministically during the
              generation wizard. If you don't need a Customer Mobile App, you
              don't pay for it.
            </p>
          </div>
