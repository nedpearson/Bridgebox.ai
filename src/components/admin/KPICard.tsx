...
export default function KPICard({
  ...
  return (
    <div className="bg-slate-900 shadow-lg shadow-black/20 border-t-2 border-t-indigo-500/50 border border-slate-800/80 rounded-xl p-6 hover:border-indigo-500/30 transition-all duration-300 relative overflow-hidden group">
      ...
      <div className="flex items-start justify-between mb-4 relative z-10">
        <div>
          <p className="text-slate-400 text-xs tracking-wider uppercase font-semibold mb-2">
            {title}
          </p>
