...
const FEATURE_PREVIEW_COPY: Partial<
  Record<FeatureKey, { headline: string; bullets: string[] }>
> = {
...
export default function LockedFeaturePanel({
  ...
  const displayHeadline =
    headline ?? preview?.headline ?? `Upgrade to unlock this feature`;
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          "linear-gradient(135deg, rgba(15,15,30,0.95) 0%, rgba(20,15,40,0.95) 100%)",
        border: "1px solid rgba(245,158,11,0.2)",
