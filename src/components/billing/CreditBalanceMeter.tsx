...
export default function CreditBalanceMeter({
  ...
  const barColor = isCritical ? "#ef4444" : isLow ? "#f59e0b" : "#6366f1";
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, rgba(15,15,30,0.9) 0%, rgba(20,20,45,0.9) 100%)",
        border: `1px solid ${barColor}30`,
    ...
    >
        ...
        <div className="flex items-center gap-2 text-slate-500 text-xs mb-4">
          ...
          <span>
            ...
            <span className="text-white font-medium">
              {Math.min(monthlyAllowance, creditsUsed * 2)}
            </span>{" "}
            credits this month
          </span>
        </div>
      ...
      {showTopUpCTA && !isUnlimited && isLow && (
        <button
          ...
          onMouseEnter={(e) =>
            (e.currentTarget.style.background = `${barColor}25`)
          }
          onMouseLeave={(e) =>
            (e.currentTarget.style.background = `${barColor}15`)
          }
        >
