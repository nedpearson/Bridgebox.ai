...
export default function EmptyState({ icon: Icon, title, description, action }: EmptyStateProps) {
  return (
    ...
    >
      <div className="w-20 h-20 bg-gradient-to-br from-indigo-500/10 to-[#10B981]/10 rounded-full flex items-center justify-center mb-6 shadow-inner ring-1 ring-slate-800">
