...
const HOW_IT_WORKS = [
  {
    step: "01",
    label: "Describe your current tools",
    detail: "by voice, text, or recording",
  },
  {
    step: "02",
    label: "Tell us what to keep and change",
    detail: "features, workflows, frustrations",
  },
  {
    step: "03",
    label: "Upload screen recordings",
    detail: "optional — we'll extract the logic",
  },
  {
    step: "04",
    label: "We generate your software blueprint",
    detail: "custom-built for your business",
  },
];

export default function VoiceToAppHero({
  onVoiceClick,
  onRecordingClick,
  onTypeClick,
}: VoiceToAppHeroProps) {
      ...
      <div className={styles.heroContent}>
        ...
        >
          ...
          <p className={styles.subheadline}>
            Show us the tools you use today. Tell us what you want to keep,
            change, or remove. Bridgebox listens — by voice, text, or screen
            recording — and generates a custom software blueprint tailored to
        ...
        >
          ...
          >
            <div
              className={`${styles.primaryCtaIcon} ${styles.pulseAnimation}`}
            >
        ...
        >
          ...
          <Link to="/app/software-discovery" className={styles.discoveryLink}>
