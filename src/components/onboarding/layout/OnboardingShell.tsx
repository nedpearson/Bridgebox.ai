...
export default function OnboardingShell() {
  ...
  if (!session)
    return (
      <div className="h-screen bg-slate-950 p-8">
        <ErrorState message="Onboarding Session not found or unauthorized." />
      </div>
    );
          ...
          <div>
            ...
            <div className="flex items-center space-x-3 text-xs text-slate-400 mt-0.5">
              <span className="flex items-center">
                <Activity className="w-3 h-3 mr-1 text-emerald-400" /> Active
                Session
              </span>
          ...
          <div className="mt-auto p-6 border-t border-white/5">
            <div className="p-4 bg-indigo-950/30 border border-indigo-500/20 rounded-xl">
              ...
              <p className="text-xs text-slate-400 leading-relaxed mb-3">
                The Copilot is actively processing your inputs into a verified
                systemic blueprint.
              </p>
